...
# run demo if data in FASTQ format
time python3 ../bin/MAP2B.py -i data.list -p 3
# run demo if data in CRAM format
# time python3 ../bin/MAP2B.py -i data.list -gm data/Homo_sapiens_assembly38.fasta
